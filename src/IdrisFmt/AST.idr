...
||| Fixity direction.
public export data Fixity : Type where
                InfixL : Fixity
                InfixR : Fixity
                Infix : Fixity
                Prefix : Fixity
...
||| Visibility modifier.
public export data Visibility : Type where
                Private : Visibility
                Export : Visibility
                Public : Visibility

||| Function options.
public export data FnOpt : Type where
                Inline : FnOpt
                TCInline : FnOpt
                NoInline : FnOpt

||| Import declaration metadata.
public export record ImportDecl where
...
public export record FixityDecl where
...
mutual
  ...
  public export data Decl : Type -> Type where
                  ...
                  DBlank : Nat -> Decl nm
  ||| Expression AST.
  public export data Expr : Type -> Type where
                  ERef : nm -> Expr nm
  ...
  public export data Clause : Type -> Type where
  ...
  public export data StringPart : Type -> Type where
  ...
  ||| Do-block statement.
  public export data DoStmt : Type -> Type where
  ...
  public export record ConDecl (nm : Type) where
  ...
  public export record FieldDecl (nm : Type) where
  ...
  public export record ImplDecl (nm : Type) where
  ...
  public export data OpStr : Type -> Type where
                  OpSymbols : String -> OpStr nm
                  Backticked : nm -> OpStr nm
  ||| Primitive literal values.
  public export data Constant : Type where
